	 ...
	 search: function (req, res) {
  	...
  	check: function (req, res) {
	 	...
	 	if ((req.param('id')!=null || req.param('city')!=null) 
			...
			function findAvail(ids, req, res) {
				Avail.find({where: {
		   		  hotelId : ids, 
				  ...
				  available: true 
						...
						var array = mapReduceAvail(data, days);
		  				console.log(array);
			...
			//valid results
			function mapReduceAvail(data, days) {
				var array = []
				var map = []
				var lastId = null;
				var i = 0;
			...
			if (req.param('id')!=null && req.param('id')!=undefined) {
				...
				Hotel.find({
				  city : req.param('city')
		  				...
		  				return findAvail(array, req, res);
